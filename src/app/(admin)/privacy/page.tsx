...
export const metadata = {
  title: 'Privacy Policy | FetchFocus',
  description: 'Privacy policy for FetchFocus platform',
};
        ...
        <div className="space-y-4 md:space-y-8">
          ...
          <div className="prose prose-sm max-w-none text-slate-700 space-y-6">
            <section>
              ...
              <p>
                FetchFocus (&quot;we,&quot; &quot;us,&quot; &quot;our,&quot; or &quot;Company&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-slate-900 mb-3">3. Use of Your Information</h2>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-slate-900 mb-3">4. Disclosure of Your Information</h2>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-slate-900 mb-3">5. Security of Your Information</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold text-slate-900 mb-3">6. Contact Us</h2>
